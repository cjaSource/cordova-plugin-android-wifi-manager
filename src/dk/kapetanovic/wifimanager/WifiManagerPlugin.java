...
public class WifiManagerPlugin extends CordovaPlugin {
    ...
    private void setHotspotEnabled(boolean enable, CallbackContext callbackContext) {

    try {

        WifiManager wifiManager =
            (WifiManager) cordova.getActivity()
            .getApplicationContext()
            .getSystemService(Context.WIFI_SERVICE);

        // Try modern tethering API first
        try {

            ConnectivityManager cm =
                (ConnectivityManager) cordova.getActivity()
                .getSystemService(Context.CONNECTIVITY_SERVICE);

            Method startTethering =
                cm.getClass().getDeclaredMethod(
                    "startTethering",
                    int.class,
                    boolean.class,
        ...
        // Fallback to old WifiManager method
